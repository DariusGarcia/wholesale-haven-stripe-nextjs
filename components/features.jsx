          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl lg:mx-0'>
              ...
              <p className='mt-6 text-lg leading-8 text-gray-600'>
                ...
                and other unique collectibles that you won&apos;t find anywhere
                else. Shop now and discover your next favorite item!
              </p>
            </div>
            <div className='mt-6 '>
              <Link
          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl lg:mx-0'>
              ...
              <p className='mt-6 text-lg leading-8 text-gray-600'>
                ...
                ourselves, and we know what you&apos;re looking for. That&apos;s
                why we offer a wide selection of high-quality acrylics to
                protect and display your collectibles. Our prices are
                unbeatable, and our customer service is second to none. Shop
                with confidence at Wholesale Haven.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8 bg-gray-50 py-4 rounded-md'>
            <div className='mx-auto max-w-2xl lg:mx-0'>
              {features.map((feature, index) => (
                <div
                  className={`my-12 ${
                    feature.border ? 'pb-12 border-b-2 border-gray-200' : 'pb-0'
                  }`}
                  key={index}
                >
